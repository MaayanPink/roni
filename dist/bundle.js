...
newLogin.addEventListener('submit', (e) => {
    ...
    const userCredential = (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.createUserWithEmailAndPassword)(auth, email, password).then(userCredential => {
...
oldLogin.addEventListener('submit', (e) => {
    ...
    //sign in  user + error
    const userCredential = (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.signInWithEmailAndPassword)(auth, email, password).then(userCredential => {
        console.log(userCredential.user);
        oldLogin.reset();
...
resetPassword.addEventListener('submit', (e) => {
    ...
    (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.sendPasswordResetEmail)(auth, email)
        .then(() => {
